...
func main() {
	...
	fmt.Println("[@main] attempting to recieve 20")
	fmt.Println(<-ch)
	fmt.Println("[@main] completed recieving 20")

	fmt.Println("[@main] attempting to recieve 30")
	fmt.Println(<-ch)
	fmt.Println("[@main] completed recieving 30")

	fmt.Println("[@main] attempting to recieve 40")
	fmt.Println(<-ch)
	fmt.Println("[@main] completed recieving 40")

	fmt.Println("[@main] attempting to recieve 50")
	fmt.Println(<-ch)
	fmt.Println("[@main] completed recieving 50")

	fmt.Println("[@main] attempting to recieve 60")
	fmt.Println(<-ch)
	fmt.Println("[@main] completed recieving 60")

	fmt.Println("[@main] attempting to recieve 70")
	fmt.Println(<-ch)
	fmt.Println("[@main] completed recieving 70")

	fmt.Println("[@main] attempting to recieve 80")
	fmt.Println(<-ch)
